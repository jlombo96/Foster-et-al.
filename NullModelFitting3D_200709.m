...
%%Specified Variables:
bindingSite = 30; %This is the size of the binding Site you are going to be testing. Important to remember that the system can't use data with DNALength == bindingSite
