...
%DNA(samples) | [DNA] in experiment, molarity of nucleotide/lattice.
...
%%Specified Variables:
%%Chaning bindingSite to 20bp and including the new data on 30bp that
%%HannahFoster e-mailed me on [200709].
...
inputPrompt = input('Which scheme do you want to test? 2 or 3:');
...
elseif (inputPrompt == 3)
    ...
    disp(modelString);
    modelString = ['R^{2} = ', num2str(IIIfitStatistics.adjrsquare)];
    disp(modelString);
...
%%%Input check.
elseif (inputPrompt ~= (2 || 3))
    disp('You have to pick either 2 or 3!');
end
